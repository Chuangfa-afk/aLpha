...
function makeHttpObject() {
 ...
 function getAssignmentAndDueDate() {
    ...
    chrome.storage.sync.set({"courseInfo": courseInfo}, function() {
        //console.log('Course info is set to ' + JSON.stringify(courseInfo));
    })

    chrome.storage.sync.set({"courseID_Arr": courseID_Arr}, function() {
